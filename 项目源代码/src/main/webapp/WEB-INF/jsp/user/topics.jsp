...
<html>
<head>
  <title>${user.userName}提出的问题</title>
    ...
    <div class="row">
      <div class="col-md-9">
        <div class="panel panel-default">
          <div class="panel-heading"><a href="/">主页</a> / ${user.userName}的问题</div>
          ...
          <div class="panel-body paginate-bot" style="border-bottom: 1px solid #e2e2e2;">
            ...
            <div class="media-left">
              ...
              <div class="media-right"><span class="badge badge-default"><a href="/topic/${item.topicId}">终结</a></span></div>
            </div>
          </div>
          </c:forEach>
