            ...
            <tr>
              ...
              <td>
                  <shiro:hasPermission name="reply:edit">
                  	<a href="${pageContext.request.contextPath}/admin/reply/edit?id=${reply.reply_id}" class="btn btn-xs btn-warning">编辑</a>
                  </shiro:hasPermission>


                <shiro:hasPermission name="reply:delete">
                  <button onclick="actionBtn('${reply.reply_id}', 'block', this)" class="btn btn-xs btn-primary">
                    <c:choose>
                      <c:when test="${reply.is_show}">取消屏蔽</c:when>
                      <c:otherwise>
                        <span>屏蔽</span>
                      </c:otherwise>
                    </c:choose>
