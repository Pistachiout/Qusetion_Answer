		...
		success : function(data) {
			...
			for(var i = 0;i < data.data.list.length; i++){
				...
				<div class=\"panel-body paginate-bot\"\
					...
					<span></span>\
					<span>•</span>\
					<a  class=\"author_name\">"+data.data.list[i].author+"</a>\
					...
					\
                  		<a href=\"/admin/topic/delete?id="+data.data.list[i].topicId+"\" class=\"media-right btn btn-xs  btn-danger\">终结</a>\
					</div>\
					</div>");
			}
		...
		success : function(data) {
			...
			for(var i = 0;i < data.data.list.length; i++){
				$(".table-striped").append("<tr>\
					<td>\
					<div class=\"media-body\">"+formatDate(Date.parse(data.data.list[i].createDate))+" 回复了 <a\
					>"+data.data.list[i].author+"</a> 提出的问题› \
					<a href=\"/topic/"+data.data.list[i].topicId+"\">"+data.data.list[i].title+"</a>\
					</div>\
					<div class=\"media-right\">\
					<a href=\"/admin/reply/edit?id="+data.data.list[i].replyId+"\" class=\"media-right btn btn-xs btn-warning\">"+"编辑"+"</a>\
					<a href=\"/admin/reply/delete?id="+data.data.list[i].replyId+"\" class=\"media-right btn btn-xs btn-danger\">"+"删除"+"</a></td>\
					<div>\
					</tr>\
		...
		success : function(data) {
			...
			for(var i = 0;i < data.data.list.length; i++){
				$(".itemList").append("<div class=\"panel-body paginate-bot\" style=\"border-bottom: 1px solid #e2e2e2;\">\
					<div class=\"media\">\
					<div class=\"media-left\"><a ><img src=\""+data.data.list[i].avatar+"\" class=\"avatar img-circle\" alt=\"\"></a></div>\
					<div class=\"media-body\">\
					<div class=\"title\"><a href=\"/topic/"+data.data.list[i].topicId+"\"> "+data.data.list[i].title+" </a></div>\
					<div class=\"tip\">\
					<p>\
